...
public class HomeFragment extends Fragment implements CardStackListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //set the style of how the pile of cards display on Home view
        layoutManager.setStackFrom(StackFrom.Left);
        layoutManager.setVisibleCount(4);
        layoutManager.setTranslationInterval(4);
...
//cardStackListener
    ...
    public void onCardSwiped(Direction direction) {
        if (direction == Direction.Left) {
            ...
            //add the interaction with DB stored liked articles
